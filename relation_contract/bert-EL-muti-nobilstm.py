...
import csv
import os
from relation_contract import modeling
from relation_contract import optimization
from relation_contract import tokenization
import tensorflow as tf
import numpy as np
from relation_contract import HeadSelectionScores_noBilstm
flags = tf.flags
import matplotlib.pyplot as plt
FLAGS = flags.FLAGS
from relation_contract import txt_segmented
## Required parameters
flags.DEFINE_string(
...
flags.DEFINE_float("num_train_epochs", 100,
...
class SemEvalProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "dev"), "dev")
    ...
    def _create_examples(self, data_dir, set_type):
        ...
        #         InputExample(guid=guid, text_a=text_a, text_b=None,
        #                      locations=locations, labels=labels, num_relations=num_relations))
        examples = txt_segmented.gain_format_data(set_type, data_dir)
